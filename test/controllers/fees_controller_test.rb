...
class FeesControllerTest < ActionController::TestCase
  ...
  test "should create fee" do
    assert_difference('Fee.count') do
      post :create, fee: { deleted_at: @fee.deleted_at, end_at: @fee.end_at, name: @fee.name, price: @fee.price, serial: @fee.serial, user_id: @fee.user_id }
    end
  ...
  test "should update fee" do
    patch :update, id: @fee, fee: { deleted_at: @fee.deleted_at, end_at: @fee.end_at, name: @fee.name, price: @fee.price, serial: @fee.serial, user_id: @fee.user_id }
    assert_redirected_to fee_path(assigns(:fee))
  end
